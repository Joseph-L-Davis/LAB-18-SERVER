...
app.post('/api/favorites', async (req, res) => {
  ...
  try {
    const data = await client.query(`
      ...
      VALUES ($1, $2, $3, $4)
      RETURNING id, name, thumbnail_url, num_servings, user_id as "userId"
    `, [favorite.name, favorite.thumbnail_url, favorite.num_servings, req.userId]
    );
